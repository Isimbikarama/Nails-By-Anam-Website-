...
const Menu = () => {
  return (
    <div>
      ...
      <h1 className="text-7xl glow text-white my-6" style ={{fontFamily:'bebasNeue-Regular'}}>SERVICES</h1>
      
      <div className="bg-pink-50 rounded-lg w-full max-w-4xl p-9 shadow-md">
        <div className="mb-8">
          ...
          <div className="flex mb-2">
            <img src='https://img.freepik.com/free-photo/woman-showing-her-beautiful-nails_23-2148697087.jpg?t=st=1742239069~exp=1742242669~hmac=0d7c9e38766cebba22112dd55f34b99b0a5f32f37dd24ee226c690a3720d019c&w=1800' alt="Basic manicure example" className="w-75 h-full rounded-xl object-cover mr-4" />
        ...
        <div className="mb-8">
          ...
          <div className="flex mb-2">
            <img src='https://img.freepik.com/free-photo/woman-showing-her-beautiful-nails_23-2148697087.jpg?t=st=1742239069~exp=1742242669~hmac=0d7c9e38766cebba22112dd55f34b99b0a5f32f37dd24ee226c690a3720d019c&w=1800' alt="Acrylic nails example" className="w-75 h-full rounded-xl object-cover mr-4" />
            <div className="flex-1">
              <div className="flex justify-between mb-1">
        ...
        <div className="mb-8">
          ...
          <div className="flex mb-2">
            <img src='https://img.freepik.com/free-photo/woman-showing-her-beautiful-nails_23-2148697087.jpg?t=st=1742239069~exp=1742242669~hmac=0d7c9e38766cebba22112dd55f34b99b0a5f32f37dd24ee226c690a3720d019c&w=1800' alt="Add-on services example" className="w-75 h-full rounded-md object-cover mr-4" />
            <div className="flex-1">
              <div className="flex justify-between mb-1">
