      ...
      <div className="relative max-w-7xl w-full min-h-[600px] flex flex-col lg:block">
        ...
        <div className="bg-pink-100 bg-opacity-70 p-8 rounded-3xl flex flex-col justify-center items-center text-center w-[300px] h-[300px] -mt-10 mx-auto lg:mt-0 lg:w-2/5 lg:h-[500px] shadow-lg lg:absolute lg:left-0 lg:top-1/2 lg:-translate-y-1/2 lg:-translate-x-[-10%] relative z-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <button className="bg-pink-300 text-black px-6 py-3 lg:px-8 lg:py-4 text-sm lg:text-lg rounded-lg font-semibold hover:bg-pink-400 transition-colors duration-300 shadow-md cursor-pointer" style={{fontFamily:'PTSerif-Regular'}}>
